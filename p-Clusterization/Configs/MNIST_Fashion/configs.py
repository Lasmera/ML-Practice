...
ROOT_DIR = '/Users/alexanderkulikov/CourceML/P-MNIST-Fashion/'
DATASET_NAME = 'MNIST_Fashion/'

TEST_DIR = ROOT_DIR + 'test/'
DATA_DIR = ROOT_DIR + 'DATA/' + DATASET_NAME
VIS_DIR = ROOT_DIR + 'visualization/' + DATASET_NAME
MODEL_SAVE_DIR = ROOT_DIR + 'save/' + DATASET_NAME
MULTI_TASK_MODEL = '20170814-153653'
TEST_DATA_DIR = TEST_DIR + 'Data/Test/' + DATASET_NAME
LOG_DIR = ROOT_DIR + 'Logs/' + DATASET_NAME
RESULT_DIR = ROOT_DIR + 'result/' + DATASET_NAME
TEMPLATE_DIR = ROOT_DIR + 'templates/' + DATASET_NAME
STATIC_DIR = ROOT_DIR + 'static/' + DATASET_NAME
SCRIPT_DIR = ROOT_DIR + 'script/' + DATASET_NAME
