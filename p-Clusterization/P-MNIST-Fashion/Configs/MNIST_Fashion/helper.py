...
from Configs.MNIST_Fashion.configs import SYNC_INTERVAL, ENABLE_LOGS, LOGGER, LOG_PATH
from Configs.MNIST_Fashion.configs import ROOT_DIR, SYNC_TIMEOUT, RESULT_PATH, SYNC_SCRIPT_PATH
