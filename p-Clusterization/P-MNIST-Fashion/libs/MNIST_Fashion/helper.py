...
from configs_MNIST_Fashion import SYNC_INTERVAL, ENABLE_LOGS, LOGGER, LOG_PATH
from configs_MNIST_Fashion import ROOT_DIR, SYNC_TIMEOUT, RESULT_PATH, SYNC_SCRIPT_PATH
